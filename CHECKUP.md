...
<div align="center">
  <img src="https://img.shields.io/badge/Total_Score-47%2F100-yellow?style=for-the-badge&logo=codecov" alt="Total Score"/>
...
| Attribute           | Value                                 |
| :------------------ | :------------------------------------ |
| **Student**         | `Begüm AKYÜZ` (`2420191005`) |
| **Course**          | `secure-web`                       |
...
| **Commit Consistency** | `40` |     10     | Avoid single-commit dumps. Surgery shouldn't be a single cut.           |
...
- **[WARNING]** System detected massive code commits in a single span of less than `24 hours`. Points deducted due to lack of incremental agile flow.
